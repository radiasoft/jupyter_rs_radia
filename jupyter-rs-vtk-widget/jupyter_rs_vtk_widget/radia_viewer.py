...
def _colors_from_string(s):
    return map(lambda x: int(x, 16), re.findall('.{6}', s))
...
class RadiaGeomMgr():
    ...
    COLOR_MAP = {
        'grayscale': ['#333', '#fff'],
        'afmhot': _colors_from_string(
            ''),
        'coolwarm': _colors_from_string(
        ...
        'jet': _colors_from_string(
            ''),
        'viridis': _colors_from_string(
    ...
    def vector_field_to_data(self, name, include_geom=True):
        ...
        cm = list(self.COLOR_MAP['viridis'])
        num_colors = len(cm)  # 16777216
        ...
        for i in range(len(pv_arr)):
            v = pv_arr[i][1]
            norm = linalg.norm(v)
            v_normed = (norm - v_min) / v_range
            #cn = math.floor(vn * num_colors)
            c_index = math.floor(v_normed * (num_colors - 1))
            cn = cm[c_index]
            r = (cn / (256 * 256) - 1) / 255.
            g = ((cn - r * 256 * 256) / 256 - 1) / 255.
            b = ((cn - r * 256 * 256 - g * 256) - 1) / 255.
